    ...
    <main className="min-h-screen bg-[#FCFAF8] text-slate-900 overflow-x-hidden" data-testid="cookies-page">
      ...
      >
        ...
        <LegalSection number={4} title="Бисквитки от трети страни">
          ...
          <ul>
            <li><strong>Google Analytics 4</strong> — за анализ на трафика; аналитични cookies се използват само след съгласие</li>
            <li><strong>Meta (Facebook) Pixel</strong> — за рекламни кампании; зарежда се само след маркетингово съгласие</li>
            <li><strong>Outbrain Pixel</strong> — за измерване и оптимизиране на кампании в Outbrain; зарежда се само след маркетингово съгласие</li>
          ...
          <div className="not-prose mt-5 p-4 rounded-xl bg-teal-50/70 ring-1 ring-teal-100">
            <p className="text-teal-900 text-sm leading-relaxed">
              <strong>Google Consent Mode v2:</strong> Zubite.bg използва Google Consent Mode v2. При първо посещение по подразбиране аналитичните и маркетинговите cookies са <strong>отказани</strong>. Преди съгласие Google може да получи ограничен технически сигнал без аналитични или рекламни cookies. Пълното аналитично съхранение се активира само ако приемете аналитичните cookies от банера. Можете да промените избора си по всяко време.
            </p>
          </div>
        </LegalSection>
