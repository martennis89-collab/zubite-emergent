...
const FAQ = [
  { q: 'Как получавам Zubite Care Pass?',                        a: 'След като заявиш насочване чрез Zubite.bg и проведеш физическа консултация в участваща партньорска клиника, клиниката ще ти предостави Zubite Care Pass, когато условията са изпълнени. Онлайн консултацията сама по себе си не отключва Care Pass.' },
  ...
  { q: 'Care Pass абонамент или членска такса ли е?',             a: 'Не. Care Pass не е абонамент. Получаваш го еднократно от участваща клиника след физическа консултация.' },
        ...
        <div className="relative max-w-4xl mx-auto px-5 sm:px-8">
          <div className="relative rounded-[2rem] bg-white/55 backdrop-blur-2xl ring-1 ring-white/70 shadow-[0_20px_60px_-20px_rgba(15,23,42,0.18)] px-6 sm:px-12 py-12 sm:py-16 text-center">
            ...
            <p className="mt-4 text-slate-600 text-base sm:text-lg leading-relaxed max-w-2xl mx-auto">
              Провери своя случай, заяви насочване и след физическа консултация
              в участваща клиника може да отключиш Zubite Care Pass.
            </p>
