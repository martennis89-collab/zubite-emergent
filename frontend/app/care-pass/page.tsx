...
export const metadata: Metadata = {
  title: 'Zubite Care Pass за всеки наш пациент | Zubite.bg',
  description:
  ...
  openGraph: {
    title: 'Zubite Care Pass — включен в партньорската ни мрежа',
    description:
      'Care Pass е включен в партньорската ни мрежа. Всеки Zubite пациент получава Care Pass при посещение в партньорска клиника. Не е застраховка и не е автоматична отстъпка от лечение.',
  ...
  twitter: {
    ...
    title: 'Zubite Care Pass — за всеки наш пациент',
    description:
...
const STEPS = [
  ...
  { n: '04', t: 'Получаваш Care Pass',   s: 'При посещение в партньорска клиника получаваш Zubite Care Pass — отстъпки за орална хигиена. Включен е за всеки наш пациент.', icon: <Gift className="w-5 h-5" />, accent: true },
] as const
...
const FAQ = [
  { q: 'Как получавам Zubite Care Pass?',                        a: 'Care Pass е включен в партньорската ни мрежа. След като заявиш насочване чрез Zubite.bg и посетиш партньорска клиника, клиниката ще ти предостави Zubite Care Pass. Всеки наш пациент получава Care Pass при посещение в партньорска клиника.' },
  ...
  { q: 'Care Pass отстъпка от лечение ли е?',                     a: 'Не. Care Pass не намалява цената на лечение или процедури в клиниката. Отстъпките са за партньорски продукти за орална хигиена. Не е застраховка и не е автоматична отстъпка от лечение.' },
  { q: 'Care Pass абонамент или членска такса ли е?',             a: 'Не. Care Pass не е абонамент. Получаваш го еднократно от партньорската клиника при твоето посещение.' },
  { q: 'Care Pass застраховка ли е?',                             a: 'Не. Care Pass не е застрахователен продукт и не покрива медицински разходи. Това е стандартна допълнителна полза за всеки пациент, който стига до партньорска клиника чрез Zubite.bg.' },
        ...
        <div className="relative max-w-6xl mx-auto px-5 sm:px-8 grid lg:grid-cols-[1fr_1fr] gap-10 lg:gap-16 items-center">
          <div>
            ...
            <h1 className="mt-5 font-serif text-4xl sm:text-5xl lg:text-6xl font-semibold text-slate-900 leading-tight">
              Care Pass — за <em className="not-italic text-teal-600">всеки</em> наш пациент в партньорска клиника.
            </h1>
            <p className="mt-5 text-slate-600 text-base sm:text-lg leading-relaxed max-w-xl">
              Care Pass е включен в партньорската ни мрежа. Когато стигнеш до
              партньорска клиника чрез Zubite.bg, клиниката ти предоставя
              Zubite Care Pass — карта с отстъпки за продукти за орална хигиена.
            </p>
            ...
            <div className="mt-6 flex flex-wrap gap-2">
              {['Включен за всеки наш пациент', 'Без допълнителна такса', 'Не е отстъпка от лечение'].map((c) => (
                <span
                  key={c}
        ...
        <div className="relative max-w-4xl mx-auto px-5 sm:px-8">
          <div className="relative rounded-[2rem] bg-white/55 backdrop-blur-2xl ring-1 ring-white/70 shadow-[0_20px_60px_-20px_rgba(15,23,42,0.18)] px-6 sm:px-12 py-12 sm:py-16 text-center">
            ...
            <p className="mt-4 text-slate-600 text-base sm:text-lg leading-relaxed max-w-2xl mx-auto">
              Провери своя случай, заяви насочване и когато стигнеш до
              партньорска клиника, ще получиш Zubite Care Pass — включен за
              всеки наш пациент.
            </p>
            ...
            <p className="mt-3 text-[12px] text-slate-500 leading-relaxed max-w-lg mx-auto">
              Care Pass е стандартна част от партньорската ни мрежа — всяка партньорска клиника го предоставя на всеки Zubite пациент.
            </p>
