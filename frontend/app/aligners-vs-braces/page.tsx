...
const FAQS = [
  { 
    ...
    a: 'При леки до умерени случаи алайнерите обикновено са по-бързи (6–18 месеца). При сложни случаи Invisalign също може да работи много добре чрез SmartTrack материала, attachments и refinements — резултатите често са сравними с брекети. При много тежки скелетни несъответствия брекети или комбиниран подход може да дадат по-предвидими резултати за 18–24 месеца.' 
  },
  { 
