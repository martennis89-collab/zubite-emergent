...
const TREATMENTS = [
  { 
    ...
    description: 'Невидими, свалящи се шини — при правилен план могат да лекуват и сложни случаи',
...
const FAQS = [
  ...
  { q: 'Мога ли да изправя зъбите си без брекети?', a: 'Да! Прозрачните алайнери (като Invisalign) са отлична алтернатива не само за леки и умерени, но и за много сложни случаи — благодарение на SmartTrack материала, ClinCheck планирането, attachments и refinements. Те са почти невидими и се свалят за хранене. При много тежки скелетни несъответствия лекарят може да препоръча брекети или комбиниран подход.' },
