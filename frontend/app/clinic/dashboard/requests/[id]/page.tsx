...
interface PatientContextQuizRow {
  question_label: string
  answer_label: string
}

interface PatientContextSource {
...
//
// Operational context shown to the clinic after the request is
// assigned. Patient-reported only. Never diagnostic. No raw JSON, no
// raw UTM dump, no internal scoring breakdown.
...
function PatientContextSection({ ctx }: { ctx: PatientContext }) {
