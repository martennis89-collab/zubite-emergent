...
const SINGLE_IMPLANT_PRICES = [
  { brand: 'Osstem (Корея)', price: '€410 – €615', note: 'Добро съотношение цена-качество' },
  { brand: 'MIS (Израел)', price: '€460 – €665', note: 'Популярен избор в България' },
  { brand: 'Straumann (Швейцария)', price: '€715 – €920', note: 'Премиум качество', premium: true },
  { brand: 'Nobel Biocare (Швеция)', price: '€770 – €1 025', note: 'Световен лидер', premium: true }
]

const FULL_SOLUTIONS = [
  { name: 'Единичен имплант + коронка', description: 'Пълно решение за 1 липсващ зъб', price: '€770 – €1 800' },
  { name: 'Мост върху 2 импланта', description: 'За 3-4 съседни липсващи зъби', price: '€1 800 – €3 070' },
  { name: 'All-on-4', description: 'Пълна челюст върху 4 импланта', price: '€4 100 – €7 670', popular: true },
  { name: 'All-on-6', description: 'Пълна челюст върху 6 импланта', price: '€5 110 – €10 225' }
]

const CITY_PRICES = [
  { city: 'София', slug: 'sofia', range: '€770 – €10 225', note: 'Най-широк избор на специалисти' },
  { city: 'Пловдив', slug: 'plovdiv', range: '€665 – €9 205', note: 'Отлични цени за качеството' },
  { city: 'Варна', slug: 'varna', range: '€615 – €8 180', note: 'Популярна дестинация за дентален туризъм' }
]
...
const FAQS = [
  { q: 'Колко струва един зъбен имплант с коронката?', a: 'Пълната цена за имплант + коронка е между €770 и €1 800 в зависимост от марката на импланта и материала на коронката (метало-керамика или циркон).' },
      ...
      <section className="pt-28 pb-16 md:pt-36 md:pb-20 bg-gradient-to-b from-white to-slate-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <div className="bg-teal-50 rounded-2xl border border-teal-200 p-6 inline-block">
            ...
            <p className="text-4xl font-bold text-teal-700">€410 – €10 225</p>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <p className="text-sm text-slate-400 text-center mt-6">
            * Цените са само за импланта. Коронката се заплаща отделно (€205 – €615).
          </p>
        </div>
      </section>
