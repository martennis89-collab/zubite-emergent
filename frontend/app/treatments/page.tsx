...
const FAQ = [
  ...
  {
    q: 'Как работи Care Pass?',
    a: 'Care Pass е включен в партньорската ни мрежа. Всеки Zubite пациент получава Care Pass при посещение в партньорска клиника. Не е застраховка и не е автоматична отстъпка от лечение.',
  },
] as const
...
export default function TreatmentsPage() {
  return (
    ...
    >
      ...
      {/* ─── Care Pass compact strip ──────────────────── */}
      <section
        className="relative py-10 sm:py-14"
        data-testid="treatments-care-pass-strip"
      >
        <div className="max-w-4xl mx-auto px-5 sm:px-8">
          <div className="relative rounded-2xl bg-white/70 backdrop-blur-xl ring-1 ring-white/80 shadow-[0_8px_30px_-20px_rgba(15,23,42,0.18)] p-5 sm:p-6 flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-6">
            ...
            <p className="flex-1 text-sm sm:text-[15px] text-slate-700 leading-relaxed">
              ...
              получава Care Pass при посещение в партньорска клиника.
            </p>
            <Link
              href="/care-pass"
              data-testid="treatments-care-pass-link"
