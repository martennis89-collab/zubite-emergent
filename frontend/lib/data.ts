...
export const CITY_FAQS: Record<string, Record<string, Array<{ q: string; a: string }>>> = {
  sofia: {
    orthodontics: [
      { q: 'Колко струва ортодонтско лечение в София?', a: 'Цените в София варират от €1 300 до €4 100 в зависимост от типа лечение (брекети или алайнери) и сложността на случая. Тези цени са ориентировъчни.' },
      ...
      { q: 'Invisalign или брекети - кое е по-добро?', a: 'И двете опции са ефективни. Invisalign е по-дискретен и удобен и при правилен план може да лекува много сложни случаи благодарение на SmartTrack материала, attachments и ClinCheck планирането. При много тежки скелетни несъответствия брекети или хибриден подход може да са по-предвидим избор. Решението зависи от конкретния случай и опита на лекаря.' },
      { q: 'Предлагат ли се разсрочени плащания?', a: 'Да, повечето клиники в София предлагат разсрочено плащане на 6, 12 или 24 месеца.' }
    ],
    implants: [
      { q: 'Каква е цената на зъбен имплант в София?', a: 'Цената на единичен имплант в София варира от €410 до €1 300. Цените са ориентировъчни и зависят от марката и необходимите процедури.' },
    ...
    'cosmetic-dentistry': [
      { q: 'Колко струват порцелановите фасети в София?', a: 'Цените на фасети в София варират от €205 до €615 на зъб. Тези цени са ориентировъчни.' },
    ...
    'sleep-airway': [
      ...
      { q: 'Колко струва орален апарат за апнея?', a: 'Цените са ориентировъчни и варират от €410 до €1 025 в зависимост от типа апарат.' },
    ...
    tmj: [
      ...
      { q: 'Колко струва лечението на TMJ?', a: 'Цените са ориентировъчни и варират от €155 до €770 в зависимост от необходимото лечение.' },
  ...
  plovdiv: {
    orthodontics: [
      { q: 'Какви са цените за ортодонтия в Пловдив?', a: 'Ортодонтското лечение в Пловдив струва ориентировъчно от €1 125 до €3 580.' },
    ...
    implants: [
      { q: 'Колко струват имплантите в Пловдив?', a: 'Цените на импланти в Пловдив са ориентировъчно от €360 до €1 125 на имплант.' },
    ...
    'cosmetic-dentistry': [
      ...
      { q: 'Колко струва избелването в Пловдив?', a: 'Професионалното избелване струва ориентировъчно от €100 до €255.' },
  ...
  varna: {
    orthodontics: [
      { q: 'Какви са цените за брекети във Варна?', a: 'Металните брекети струват ориентировъчно от €1 025 до €1 800, керамичните от €1 535 до €2 555.' },
    ...
    'sleep-airway': [
      ...
      { q: 'Колко е цената ориентировъчно?', a: 'Цените варират от €360 до €920 в зависимост от типа апарат.' },
