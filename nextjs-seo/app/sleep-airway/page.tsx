...
import { PRICE_DISCLAIMER, EDUCATIONAL_DISCLAIMER, TREATMENT_PRICES } from '@/lib/pricing'
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
            <div>
              ...
              <p className="text-slate-600 mb-6">
                Ако не сте сигурни дали оралните апарати са подходящи за вас, оставете данни и нашият екип ще се свърже с вас.
              </p>
            ...
            <LeadCaptureForm treatmentType="sleep-airway" source="sleep_airway_page" />
          </div>
        </div>
      </section>
