      ...
      <section className="pt-28 pb-20 md:pt-36 md:pb-28 bg-white overflow-hidden">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-lg text-slate-600 max-w-2xl mx-auto mb-4 animate-fade-in-up animate-delay-100">
            Отговорете на няколко въпроса и получете препоръка за лечение, ориентировъчни цени и 2–3 опции за клиники според вашия случай.
          </p>
          <p className="text-base text-slate-500 max-w-xl mx-auto mb-12 animate-fade-in-up animate-delay-100">
            Сравняваме алайнери vs брекети и най-популярните марки алайнери (Invisalign, Spark, Angel Aligner).
          </p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              { title: 'Сравнение на опции', text: 'Сравнение: алайнери vs брекети + марки алайнери.' },
              { title: 'Персонализирана препоръка', text: 'Препоръка според вашия случай — не според реклама.' }
            ].map((item, index) => (
              <div 
                key={index} 
