...
const ORTHO_QUESTIONS = [
  {
    ...
    options: [
      { value: 'straight_teeth', label: 'Подредени зъби' },
      { value: 'better_bite', label: 'По-добра захапка' },
      { value: 'both', label: 'И двете' }
    ]
  },
  {
    id: 'visibility',
    question: 'Колко важна е дискретността на лечението?',
    options: [
      { value: 'very_important', label: 'Много важна - искам невидимо лечение' },
      { value: 'somewhat', label: 'Донякъде важна' },
      { value: 'not_important', label: 'Не е толкова важна' }
    ]
  },
  {
    id: 'discipline',
    question: 'Смятате ли, че можете да носите алайнери 20-22 часа на ден?',
    options: [
      { value: 'yes', label: 'Да, без проблем' },
      { value: 'maybe', label: 'Ще се постарая' },
      { value: 'no', label: 'Предпочитам нещо постоянно' }
    ]
  },
  {
    id: 'complexity',
    question: 'Какво описва зъбите ви?',
    options: [
      { value: 'minor', label: 'Леко изкривяване' },
      { value: 'moderate', label: 'Умерено изкривяване' },
      { value: 'severe', label: 'Сериозни проблеми със захапката' }
    ]
  },
  {
    id: 'budget',
    ...
    options: [
      { value: 'premium', label: 'Готов съм да инвестирам за най-доброто (5000-8000 лв)' },
      { value: 'mid', label: 'Търся добро съотношение цена/качество (3000-5000 лв)' },
      { value: 'budget', label: 'Търся най-достъпната опция (2500-3500 лв)' }
    ]
  },
  {
    id: 'timing',
...
export default function OrthoQuizPage() {
  ...
  const handleAnswer = (value: string) => {
    ...
    if (currentQuestion < ORTHO_QUESTIONS.length - 1) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const leadData = {
        ...
        answers: { ...answers, quiz_type: quizType },
            ...
            <>
              ...
              <div className="mb-8">
                <div className="flex justify-between text-sm text-slate-400 mb-2">
                  <span>Въпрос {currentQuestion + 1} от {ORTHO_QUESTIONS.length}</span>
